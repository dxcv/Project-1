...
col_query = "select name from syscolumns where id = object_id('{}')".format('Stock_Abnormal_SalesDepartment_Daily')
...
df.to_sql('Stock_Abnormal_SalesDepartment_Daily',dbqu.conn,if_exists='append',index=False,chunksize=1000)