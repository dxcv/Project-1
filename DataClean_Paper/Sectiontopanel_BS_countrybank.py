...
pathbankname = r'D:\Paper\Data\Original_BankScope\BankName_countrybank.xlsx'
...
result.to_excel(pathto+'\\BankName_countrybank.xlsx',index=True)
result.to_stata(pathto+'\\BankName_countrybank.dta',write_index=False)