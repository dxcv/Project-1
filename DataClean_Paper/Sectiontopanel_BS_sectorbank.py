...
pathbankname = r'D:\Paper\Data\Original_BankScope\BankName_sectorbank.xlsx'
...
result.to_excel(pathto+'\\BankName_sectorbank.xlsx',index=True)
result.to_stata(pathto+'\\BankName_sectorbank.dta',write_index=False)