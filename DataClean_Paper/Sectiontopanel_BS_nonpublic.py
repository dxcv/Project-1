...
pathbankname = r'D:\Paper\Data\Original_BankScope\BankName_nonpublic.xlsx'
...
result.to_excel(pathto+'\\BankName_nonpublic.xlsx',index=True)
result.to_stata(pathto+'\\BankName_nonpublic.dta',write_index=False)