...
pathbankname = r'D:\Paper\Data\Original_BankScope\BankName_public.xlsx'
...
result.to_excel(pathto+'\\BankName_public.xlsx',index=True)
result.to_stata(pathto+'\\BankName_public.dta',write_index=False)